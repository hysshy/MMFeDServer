...
data = [
    dict(
        ...
        train=dict(
            type='CocoDataset',
            ann_file='/home/chase/shy/dataset/publicDatas/lunwenjson/carDetect_train_res_2_0.json',
            img_prefix='',
    ...
    dict(
        ...
        train=dict(
            type='CocoDataset',
            ann_file='/home/chase/shy/dataset/publicDatas/lunwenjson/carDetect_train_res_2_1.json',
            img_prefix='',
            pipeline=train_pipeline),
        val=dict(
            type='CocoDataset',
    ...
    dict(
        ...
        train=dict(
            type='CocoDataset',
            ann_file='/home/chase/shy/dataset/publicDatas/lunwenjson/carplateDetect_train_res_2_0.json',
            img_prefix='',
            pipeline=train_pipeline),
        val=dict(
            type='CocoDataset',
    ...
    dict(
        ...
        train=dict(
            type='CocoDataset',
            ann_file='/home/chase/shy/dataset/publicDatas/lunwenjson/carplateDetect_train_res_2_1.json',
            img_prefix='',
            pipeline=train_pipeline),
        val=dict(
            type='CocoDataset',
