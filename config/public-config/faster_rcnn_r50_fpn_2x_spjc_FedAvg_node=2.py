...
data = [
    dict(
        ...
        train=dict(
            type='CocoDataset',
            ann_file='/home/chase/shy/dataset/publicDatas/lunwenjson/faceDetect_train_res0.json',
            img_prefix='',
    ...
    dict(
        ...
        train=dict(
            type='CocoDataset',
            ann_file='/home/chase/shy/dataset/publicDatas/lunwenjson/facekp_train_res0.json',
            img_prefix='',
            pipeline=train_pipeline),
        val=dict(
            type='CocoDataset',
    ...
    dict(
        ...
        train=dict(
            type='CocoDataset',
            ann_file='/home/chase/shy/dataset/publicDatas/lunwenjson/faceGender_train_res0.json',
            img_prefix='',
            pipeline=train_pipeline),
        val=dict(
            type='CocoDataset',
    ...
    dict(
        ...
        train=dict(
            type='CocoDataset',
            ann_file='/home/chase/shy/dataset/publicDatas/lunwenjson/faceDetect_train_res1.json',
            img_prefix='',
            pipeline=train_pipeline),
        val=dict(
            type='CocoDataset',
    ...
    dict(
        ...
        train=dict(
            type='CocoDataset',
            ann_file='/home/chase/shy/dataset/publicDatas/lunwenjson/facekp_train_res1.json',
            img_prefix='',
            pipeline=train_pipeline),
        val=dict(
            type='CocoDataset',
    ...
    dict(
        ...
        train=dict(
            type='CocoDataset',
            ann_file='/home/chase/shy/dataset/publicDatas/lunwenjson/faceGender_train_res1.json',
            img_prefix='',
            pipeline=train_pipeline),
        val=dict(
            type='CocoDataset',
