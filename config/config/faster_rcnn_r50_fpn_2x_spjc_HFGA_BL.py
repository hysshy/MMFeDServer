...
total_fedbl_num = 4
custom_hooks = [dict(type='FedReload', priority='LOWEST', interval=1), dict(type='FedBL', priority='LOWEST', total_fedbl_num=total_fedbl_num), dict(type='NumClassCheckHook')]
