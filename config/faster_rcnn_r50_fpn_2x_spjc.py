...
data = [
    ...
    dict(
        ...
        train=dict(
            type='CocoDataset',
            ann_file='/home/chase/shy/dataset/spjgh/lunwenjson/carplate_train_res.json',
            img_prefix='',
            pipeline=train_pipeline),
        val=dict(
            type='CocoDataset',
            ann_file='/home/chase/shy/dataset/spjgh/lunwenjson/carplate_test_res.json',
            img_prefix='',
            pipeline=test_pipeline),
        test=dict(
            type='CocoDataset',
...
total_fedlw_num = 2
custom_hooks = [dict(type='FedReload', priority='LOWEST', interval=1), dict(type='FedLW', priority='LOWEST', total_fedlw_num=total_fedlw_num), dict(type='NumClassCheckHook')]
